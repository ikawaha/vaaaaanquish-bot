...
import (
	...
	"github.com/ikawaha/vaaaaanquish-bot/tool/cli"
...
func main() {
	...
	app := &cobra.Command{
		Use:   "vaaaaanquish-bot-cli",
		Short: `CLI client for the vaaaaanquish-bot service`,
	}
	...
	c.UserAgent = "vaaaaanquish-bot-cli/0"
